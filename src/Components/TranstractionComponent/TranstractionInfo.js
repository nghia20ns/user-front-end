...
const TranstractionInfo = () => {
    ...
    const getTrans = async () => {
        await axios
          .get("http://localhost:5000/transtraction/" + id)
          .then((res) => {
        ...
        <div className='row'>
            <div className='col-sm-6'>
                <ul className="list-group list-group-flush">
                    <li className="list-group-item"><b>User Id</b></li>
                    <li className="list-group-item"><b>Quantity</b></li>
                    <li className="list-group-item"><b>Provider</b></li>
                    <li className="list-group-item"><b>Message</b></li>
                    <li className="list-group-item"><b>Status</b></li>
                    <li className="list-group-item"><b>Product</b></li>
            ...
            <div className='col-sm-6'>
                <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item">{(infoState.message !== " ")? infoState.message : "none"}</li>
